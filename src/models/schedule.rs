...
/// Value object representing a time interval (HH:MM format)
...
/// Value object representing weekly hours allocation
#[derive(Debug, Clone, Serialize, Deserialize, ToSchema)]
...
/// Value object representing weekly time intervals
#[derive(Debug, Clone, Serialize, Deserialize, ToSchema)]
